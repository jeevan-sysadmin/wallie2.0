    ...
    >
      ...
      >
        <SubMenu label={dictionary['navigation'].dashboards} icon={<i className='tabler-smart-home' />}>
          ...
          <MenuItem href={`/${locale}/dashboards/VideoTransibe`} icon={<i className='tabler:video' />}>
            {dictionary['navigation'].VideoTransibe}
          </MenuItem>
          <MenuItem href={`/${locale}/dashboards/ConvertDocument`} icon={<i className='tabler:file-text' />}>
            {dictionary['navigation'].ConvertDocument}
          </MenuItem>
        </SubMenu>
